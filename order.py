...
ncbi_group.add_argument('--deduplicationmethod', help='Specify how identical sequences should be deduplicated; either "all" duplicates are removed; or duplicates are removed if they share biosample accession id + "submitter" metadata or "bioproject" accession id (default: "bioproject")', default="bioproject", choices=["bioproject","submitter","all"],type=str)
